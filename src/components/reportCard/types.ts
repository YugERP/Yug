...
export const getSchoolNameStyle = (name: string, isLandscape: boolean, subjectCount: number = 7) => {
  ...
  if (!isLandscape) {
    if (subjectCount <= 5) {
      sizeInPx = len < 20 ? 32 : len < 30 ? 27 : len < 40 ? 23 : len < 50 ? 19 : 16;
    } else if (subjectCount <= 8) {
      sizeInPx = len < 20 ? 28 : len < 30 ? 24 : len < 40 ? 21 : len < 50 ? 18 : 15;
    } else {
      sizeInPx = len < 20 ? 24 : len < 30 ? 21 : len < 40 ? 18 : len < 50 ? 15 : 13;
    }
  } else {
    if (subjectCount <= 6) {
...
export const getAddressStyle = (address: string, isLandscape: boolean, subjectCount: number = 7) => {
  ...
  if (!isLandscape) {
    if (subjectCount <= 5) {
      sizeInPx = len < 35 ? 12.5 : len < 55 ? 11 : 9.5;
    } else if (subjectCount <= 8) {
      sizeInPx = len < 35 ? 11.5 : len < 55 ? 10 : 8.5;
    } else {
      sizeInPx = len < 35 ? 10 : len < 55 ? 9 : 8;
    }
  } else {
    if (subjectCount <= 6) {
