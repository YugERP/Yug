...
export const LandscapeProTemplate: React.FC<ReportCardCommonProps> = ({
  ...
  return (
    <>
      ...
      <div className="border border-[#002060] rounded p-1.5 mb-1.5 bg-slate-50/20">
      ...
      <div className="grid grid-cols-12 gap-2 my-1 items-stretch">
        {/* Marks Table */}
          ...
          <table className={`w-full table-fixed border-2 border-[#002060] text-center ${dyn.tableText} font-serif border-collapse`}>
            <thead>
              <tr className="border-b-2 border-[#002060] bg-slate-50">
                <th rowSpan={2} className={`border-r-2 border-[#002060] ${dyn.cellPy} ${dyn.cellPx} text-center align-middle text-slate-800 font-black w-[17%]`}>SUBJECT</th>
              ...
              <tr className={`border-b-2 border-[#002060] ${dyn.tableSubHeader} font-bold text-slate-700 bg-slate-50/50`}>
                <th className="border-r border-[#002060] p-0.5 w-[5%]">TEST</th>
                <th className="border-r border-[#002060] p-0.5 w-[6.5%]">THEORY</th>
                <th className="border-r border-[#002060] p-0.5 w-[6%] text-indigo-900 bg-indigo-50/40">PRAC</th>
                <th className="border-r border-[#002060] p-0.5 w-[6.5%]">TOTAL</th>
