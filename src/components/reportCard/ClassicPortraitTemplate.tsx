        ...
        <table className={`w-full table-fixed border-2 border-[#002060] text-center ${dyn.tableText} font-serif border-collapse`}>
          <thead>
            ...
            <tr className={`border-b-2 border-[#002060] ${dyn.tableSubHeader} font-bold text-slate-700 bg-slate-50/50`}>
              ...
              <th className="border-r-2 border-[#002060] p-0.5 w-[7.5%] text-[#002060]">OBT.<br/>MARKS</th>
              {/* Final columns (20%) */}
              <th className="border-r border-[#002060] p-0.5 w-[6.5%]">FINAL<br/>TOTAL</th>
              <th className="border-r border-[#002060] p-0.5 w-[7.5%] text-[#002060]">FINAL OBT.<br/>MARKS</th>
